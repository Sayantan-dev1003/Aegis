...
class ModelTrainer:
    ...
    def save_model(self) -> None:
        ...
        metadata_obj = {
            ...
            "best_iteration": int(self.best_iteration),
            "best_validation_aucpr": float(self.best_score),
            "precision": self.val_metrics.get("precision", 0.0),
            "recall": self.val_metrics.get("recall", 0.0),
            "f1_score": self.val_metrics.get("f1", 0.0),
            "accuracy": self.val_metrics.get("accuracy", 0.0),
            "roc_auc": self.val_metrics.get("roc_auc", 0.0),
            "pr_auc": self.val_metrics.get("pr_auc", 0.0),
            "scale_pos_weight": self.scale_pos_weight,
